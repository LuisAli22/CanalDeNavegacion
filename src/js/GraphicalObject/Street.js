...
(function () {
    ...
    Street = function (graphicContainer, riverRightSideLimit, riverLeftSideLimit, streetWidth) {
        ...
        this.sweptSurface = new SweptSurface(graphicContainer, this.levelGeometry, this.streetTrajectory, 1 / 4096);
        this.createSideWalkLevelPoints();
        this.sideWalk = new SweptSurface(graphicContainer, this.levelGeometry, this.streetTrajectory, false);
        this.createLeftSideWalkLevelPoints();
        this.sideLeftWalk = new SweptSurface(graphicContainer, this.levelGeometry, this.streetTrajectory, false);
    };
