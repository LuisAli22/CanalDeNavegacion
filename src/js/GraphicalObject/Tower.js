...
(function () {
    ...
    Tower = function (graphicContainer, towerPosition, towerTh1, bridgeHeight) {
        ...
        this.towerCenterBody = new TowerBody(graphicContainer, this.towerTh2, 1 / 4, 1);
        this.towerBody = new TowerBody(graphicContainer, this.towerTh1, 1 / 4, 1);
        this.towerTopBody = new TowerBody(graphicContainer, this.towerTh3, 1 / 4, 1);
        this.junctionHeight = 0.2;
        this.towerJunction1 = new TowerJunction(graphicContainer, this.junctionHeight, 1 / 4, 1 / 16);
        this.textureHandler = TextureHandler.getInstance(graphicContainer);
        this.textures = this.textureHandler.initializeTexture("img/oxido.jpg");
        this.normalTextures = this.textureHandler.initializeTexture("img/oxido-normalmap.jpg");
    ...
    Tower.prototype.draw = function (modelViewMatrix) {
        ...
        this.gl.uniform1i(this.shaderProgram.isTower, 1);
        this.textureHandler.setTextureUniform(this.textures);
        this.textureHandler.setTextureNormal(this.normalTextures);
        ...
        this.gl.uniform1i(this.shaderProgram.isTower, 0);
    };
}());
